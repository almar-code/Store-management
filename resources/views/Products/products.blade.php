                    ...
                    <div class="card product-card text-white border-secondary h-100 shadow-sm mx-2 ">
                        <div class="row g-0 align-items-center px-3 py-2">
                            ...
                            <div class="col-1 text-start align-self-start">
                                <div class="dropdown">
                                    <button class="btn text-white p-0 border-0 shadow-none" type="button"
                                        data-bs-toggle="dropdown" data-bs-boundary="viewport" aria-expanded="false">
                                        <i class="bi bi-three-dots-vertical fs-4"></i>
                                    </button>
                                    <ul
                                        class="dropdown-menu dropdown-menu-dark dropdown-menu-start shadow border-secondary">
                                        <li>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center justify-content-between py-2 text-danger font-weight-bold"
                                                href="#">
