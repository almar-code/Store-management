...
@section('content')
                        ...
                        <form action="{{ isset($editProduct) ? '/update-product/' . $editProduct->p_id : '/add-product' }}"
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="productName" name="productName"
                                    placeholder="Full Name" required=""  value="{{ old('productName', $editProduct->p_name ?? '') }}">>
                            ...
                            <div class="form-floating mb-3" {{ isset($editProduct) ? 'hidden' : '' }}>
                                <input type="text" class="form-control" name="colorName" placeholder="اسم اللون" value="{{ old('colorName') }}">
    ...
    <option value="" disabled {{ !isset($editProduct) && !old('productSubcategory') ? 'selected' : '' }}>
        اختر الفئة...
    </option>
