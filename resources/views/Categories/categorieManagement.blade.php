...
<div class="main-content-wrapper" style="min-height: 100vh; direction: rtl;">
    <div class="container">
        ...
        <div class="row g-3">
            @php
                $categories = [
                    (object)['id'=>101, 'name'=>'رسمية', 'section'=>(object)['name'=>'عبايات رسمية'], 'image'=>'assets/img/photos/a3.jpg'],
                    (object)['id'=>102, 'name'=>'تخرج', 'section'=>(object)['name'=>'عبايات لحفلات تخرج'], 'image'=>'assets/img/photos/a3.jpg'],
                    (object)['id'=>103, 'name'=>'كاجول', 'section'=>(object)['name'=>'عبايات  كاجول '], 'image'=>'assets/img/photos/a3.jpg']
                ];
            @endphp
        ...
        <div class="card-body d-flex align-items-center justify-content-between py-3">
            ...
            <div class="d-flex align-items-center">
                <div class="image-holder ms-3"> 
                    <img src="{{ $category->image }}" class="rounded-circle border" width="60" height="60" alt="category" style="object-fit: cover;">
                </div>
                <div class="text-end">
    ...
    {{ Str::words($category->section->name ?? '-', 2, '...') }}
            ...
            <div class="d-flex flex-column flex-md-row align-items-end align-items-md-center">
                <a href="#" class="btn btn-sm btn-outline-dark px-3 border-secondary-subtle mb-2 mb-md-0 ms-md-2">
